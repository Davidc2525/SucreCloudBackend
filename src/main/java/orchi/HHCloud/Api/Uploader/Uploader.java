...
public class Uploader extends API {
    ...
    /**
    * clase para proceso de subida, en el proceso de parseo, los parametros, args,op,f, se leen en ese order,
    * pudiendo haci crear un proceso de armado, donde primero se obtiene de args la propiedad path, q es donde
    * se va ha almacenar dicho archivo, luego de tener el path de args, se llama el metodo, toStore q con
    * pathArgs y el path parasado por parametro se arma la rruta de destino completa,
    * <pre>
